...
/*
	Added this manually after searching for the gcc compilation warning.
	After compilation, adding this header library solved the gcc warning and compiled without errors.
*/
#include <arpa/inet.h>
#include <stdio.h>
#include <stdlib.h>
